...
const AiAvatar = () => {
  ...
  return (
    <>
      <NavDashboard />
      <div className="user-form dashboard_form">
        <TimeLine />
            ...
            {({
              ...
              <form onSubmit={handleSubmit}>
                <div className="form-details">
                  ...
                  <p className="">
                    Select 10-20 photos of yourself (or you and your partner as
                    a couple, or your dog or cat). We'll train the Al to
                    generate Al-generated avatars that look just like you in any
                    style you want.
                  </p>
                  <h6 className="">
                  ...
                  <p className="">
                    <span>Note: </span> Al can have random results and may
                    include artistic nudes, erotic or otherwise shocking images,{" "}
                    <br />
                    if you do not want that and are sensitive, we recommend you
                    to NOT use this site!
                    <br />
                    The Al may also generate artefacts and defects, this is out
                    of our control. Please accept that risk before buying!
                    <br />
                    <br />
                    or your safety: the images you upload are ONLY used to
                    generate your Al Avatars.
                    <br /> Both the images you upload and the Al model trained
                    are auto deleted within 5 Days.
                  </p>
                </div>
                ...
                <div className="select-images-box">
                  <h5 className="select-img-heading">
                    Select Images atleast 4
                  </h5>
                  <Button
